...
<?php
/*
 * Orignial Author: Adhil Azeez NV
 * Description: Generates Indian National Flag Image
 * Code modified as per independent run using command.
 */
...
if(imagejpeg($flag, 'IndiaFlag.jpg', 100))
    	echo "National Flag saved to IndiaFlag" . '.jpg';
    else
